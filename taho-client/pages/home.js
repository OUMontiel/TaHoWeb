                        ...
                        <div className='instructions-container'>
                            <div className='box'>
                                ...
                                <div className='back'>
                                    ...
                                    <p id='text'>
                                        Puedes registrarte como usuario o
                                        trabajador según tus necesidades
                                    </p>
                                </div>
                            </div>
                            <div className='box'>
                                ...
                                <div className='back'>
                                    <br />
                                    <p id='text'>
                                        2.El segundo paso es esperar a que tu
                                        cuenta sea verificada.
                                    </p>
                                </div>
                            </div>
                            <div className='box'>
                            ...
                            <div className='box'>
                                ...
                                <div className='back'>
                                    <p id='text'>
                                        ...
                                        usuario, podrás buscar trabajdores que
                                        se adapten a tus necesidades.
                                    </p>
                                    <p id='text'>
                                        En caso de ser trabajador, podrás
                                        publicar tu perfil y esperar a que te
                                        contacten.
                                    </p>
                                </div>
                            </div>
