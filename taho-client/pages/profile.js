...
export default function Profile({user}) {
    return (
        ...
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css"></link>
            <Header user={user} />
                <Button className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal">Mi Perfil</Button>
                ...
                <div className="modal-dialog">
                    ...
                    <div className="modal-header">
                        <h4 className="modal-title">Mi Perfil</h4>
                    ...
                    <div className="modal-body">
                        <div className="row">
                            ...
                            <div className="col-md-4 ms-auto">{user.firstName}</div>
                        </div>
                        <hr />
                        <div className="row">
                            <div className="col-md-4">Apellido</div>
                            <div className="col-md-4 ms-auto">{user.lastName}</div>
                        </div>
                        <hr />
                        <div className="row">
                            <div className="col-md-4">Telefono</div>
                            <div className="col-md-4 ms-auto">{user.phone}</div>
                        </div>
                    </div>
